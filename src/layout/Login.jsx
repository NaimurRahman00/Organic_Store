...
const Login = () => {
  return (
    <section className="h-screen flex justify-center items-center bg-rose-50">
      <div className="mx-auto w-full max-w-md space-y-4 rounded-lg border bg-white p-10 shadow-lg shadow-black/50">
        ...
        <form action="#" className="space-y-6">
          ...
          <button className="w- rounded-md bg-sky-500 px-4 py-2 text-white transition-colors hover:bg-sky-600 dark:bg-sky-700">
            Submit
          </button>
        </form>
        <p className="text-center text-sm text-zinc-700">
          Don&apos;t have an account?
          <Link to='/register' href="#" className="font-semibold underline">
            Signup
          </Link>
        </p>
