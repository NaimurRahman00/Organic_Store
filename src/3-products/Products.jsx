    ...
    <section className="mx-7 h-screen">
      ...
      <div className="grid grid-cols-4 gap-10 sticky top-0">
        ...
        <div className="col-span-3 grid grid-cols-3 gap-5 my-10">
          <div className="max-w-[350px] space-y-4 rounded-lg bg-emerald-50 p-6 shadow-lg shadow-black/50 md:w-full h-fit">
            <img
              width={400}
              height={400}
            ...
            <div className="flex gap-4">
              ...
              <button className="rounded-md border border-black/50 px-4 dark:border-white dark:hover:text-slate-800 dark:hover:bg-white  py-2  duration-300 hover:bg-gray-200">
                View Details
              </button>
            </div>
          </div>
